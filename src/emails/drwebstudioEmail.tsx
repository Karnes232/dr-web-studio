          ...
          <Container className="mx-auto py-8 px-4 max-w-2xl">
              ...
              <div className="">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      We'll schedule a call to discuss your vision, goals, and
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <Text className="text-gray-600 text-sm">
                      Once approved, we'll begin the design and development
            ...
            <Section className="bg-white rounded-lg shadow-lg mb-6 p-6">
              ...
              <Text className="text-gray-600 mb-4">
                ...
                questions or need to make changes to your project.
              </Text>
            ...
            <Section className="bg-orange-500 rounded-lg p-6 text-center mb-6">
              ...
              <Text className="text-orange-100 mb-4">
                Our team is already preparing to bring your website vision to
                life. We'll be in touch within 24 hours with next steps.
              </Text>
              {/* <Link 
            ...
            <Section className="text-center py-6">
              ...
              <Text className="text-gray-500 text-sm mb-2">
                © {new Date().getFullYear()} DR Web Studio. All rights
                reserved.
              </Text>
              <Text className="text-gray-500 text-sm">
                Professional website development for businesses in the Dominican
                Republic
              </Text>
