...
const PAGE_SLUG = "paginas-web-para-alquileres-vacacionales"
const PAGE_HREF = "/paginas-web-para-alquileres-vacacionales"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaAlquileresVacacionales({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-alquileres-vacacionales",
  })
