...
const PAGE_SLUG = "diseno-de-paginas-web-santo-domingo"
const PAGE_HREF = "/diseno-de-paginas-web-santo-domingo"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebSantoDomingo({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-santo-domingo",
  })
