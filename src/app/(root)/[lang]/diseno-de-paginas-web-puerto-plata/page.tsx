...
const PAGE_SLUG = "diseno-de-paginas-web-puerto-plata"
const PAGE_HREF = "/diseno-de-paginas-web-puerto-plata"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebPuertoPlata({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-puerto-plata",
  })
