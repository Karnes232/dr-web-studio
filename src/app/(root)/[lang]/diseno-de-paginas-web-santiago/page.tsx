...
const PAGE_SLUG = "diseno-de-paginas-web-santiago"
const PAGE_HREF = "/diseno-de-paginas-web-santiago"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebSantiago({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-santiago",
  })
