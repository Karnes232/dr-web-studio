...
const PAGE_SLUG = "paginas-web-para-hoteles"
const PAGE_HREF = "/paginas-web-para-hoteles"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaHoteles({ params }: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-hoteles",
  })
