...
const PAGE_SLUG = "paginas-web-para-bodas-y-eventos"
const PAGE_HREF = "/paginas-web-para-bodas-y-eventos"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaBodasYEventos({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-bodas-y-eventos",
  })
