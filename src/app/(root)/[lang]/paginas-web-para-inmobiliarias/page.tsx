...
const PAGE_SLUG = "paginas-web-para-inmobiliarias"
const PAGE_HREF = "/paginas-web-para-inmobiliarias"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaInmobiliarias({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-inmobiliarias",
  })
