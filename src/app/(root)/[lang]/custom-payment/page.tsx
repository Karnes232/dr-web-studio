      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-600">
            Enter your payment amount and complete your transaction
          </p>
        </div>
            ...
            <>
              ...
              <div className="p-8">
                <div className="text-center mb-6">
                  <div className="bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-4 py-2 rounded-lg inline-block font-semibold">
