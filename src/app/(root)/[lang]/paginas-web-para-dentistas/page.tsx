...
const PAGE_SLUG = "paginas-web-para-dentistas"
const PAGE_HREF = "/paginas-web-para-dentistas"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaDentistas({ params }: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-dentistas",
  })
