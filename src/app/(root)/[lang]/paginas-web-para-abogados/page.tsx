...
const PAGE_SLUG = "paginas-web-para-abogados"
const PAGE_HREF = "/paginas-web-para-abogados"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaAbogados({ params }: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-abogados",
  })
