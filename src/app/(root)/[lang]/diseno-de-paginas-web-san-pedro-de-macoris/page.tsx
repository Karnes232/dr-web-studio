...
import { LandingNearbyCities } from "@/components/LandingPageComponents/LandingNearbyCities"
...
const PAGE_SLUG = "diseno-de-paginas-web-san-pedro-de-macoris"
const PAGE_HREF = "/diseno-de-paginas-web-san-pedro-de-macoris"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebSanPedroDeMacoris({
  params,
}: PageProps) {
  ...
  return (
    <main>
      ...
      <LandingNearbyCities currentRoute={PAGE_HREF} lang={lang} />
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-san-pedro-de-macoris",
  })
