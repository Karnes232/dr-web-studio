...
const PAGE_SLUG = "diseno-de-paginas-web-punta-cana"
const PAGE_HREF = "/diseno-de-paginas-web-punta-cana"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebPuntaCana({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-punta-cana",
  })
