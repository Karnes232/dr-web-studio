...
const PAGE_SLUG = "paginas-web-para-constructoras"
const PAGE_HREF = "/paginas-web-para-constructoras"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaConstructoras({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-constructoras",
  })
