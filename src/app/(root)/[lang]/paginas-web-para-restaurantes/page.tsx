...
const PAGE_SLUG = "paginas-web-para-restaurantes"
const PAGE_HREF = "/paginas-web-para-restaurantes"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaRestaurantes({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-restaurantes",
  })
