...
const PAGE_SLUG = "diseno-de-paginas-web-las-terrenas"
const PAGE_HREF = "/diseno-de-paginas-web-las-terrenas"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function DisenoDePaginasWebLasTerrenas({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/diseno-de-paginas-web-las-terrenas",
  })
