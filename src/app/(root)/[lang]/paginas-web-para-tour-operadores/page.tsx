...
const PAGE_SLUG = "paginas-web-para-tour-operadores"
const PAGE_HREF = "/paginas-web-para-tour-operadores"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaTourOperadores({
  params,
}: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-tour-operadores",
  })
