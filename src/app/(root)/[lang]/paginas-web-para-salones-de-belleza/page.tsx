...
const PAGE_SLUG = "paginas-web-para-salones-de-belleza"
const PAGE_HREF = "/paginas-web-para-salones-de-belleza"

interface PageProps {
  params: Promise<{ lang: "en" | "es" }>
}

export default async function PaginasWebParaSalones({ params }: PageProps) {
...
export async function generateMetadata({
  ...
  const { canonical: canonicalUrl, languages } = buildAlternates({
    currentLocale: lang,
    hrefFor: () => "/paginas-web-para-salones-de-belleza",
  })
