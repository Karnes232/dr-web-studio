...
const CustomSolutionCTA = ({ customSolutionCTA }: { customSolutionCTA: CustomSolutionCTAData }) => {
  const { currentLocale } = useLocale()
  return (
    <div className="bg-gradient-to-r from-slate-800 to-slate-700 rounded-2xl p-8 md:p-12 text-center">
      <div className="max-w-3xl mx-auto">
        <h3 className="text-3xl font-bold text-white mb-4">
          {customSolutionCTA.title[currentLocale as keyof typeof customSolutionCTA.title]}
        </h3>
        <p className="text-slate-300 text-lg mb-8">
          {customSolutionCTA.description[currentLocale as keyof typeof customSolutionCTA.description]}
        </p>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          ...
          >
            ...
            {customSolutionCTA.questionnaireButton[currentLocale as keyof typeof customSolutionCTA.questionnaireButton]}
          </a>
          ...
          >
            ...
            {customSolutionCTA.quoteButton[currentLocale as keyof typeof customSolutionCTA.quoteButton]}
          </a>
        </div>
      </div>
    </div>
