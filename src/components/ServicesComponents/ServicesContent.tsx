...
import type { ServicesHeaderData } from "@/sanity/queries/services/servicesHeader"
import { useLocale } from "@/i18n/useLocale"
import type { FeaturesStripData } from "@/sanity/queries/services/featuresStrip"
import type { CustomSolutionCTAData } from "@/sanity/queries/services/customSolutionCTA"
import type { Category } from "@/sanity/queries/services/category"
import type { ServiceItem } from "@/sanity/queries/services/serviceItem"
...
export default function ServicesContent({
  ...
  return (
    <section
      id="services"
      className="py-20 bg-gradient-to-br from-slate-50 to-orange-50 dark:from-slate-950 dark:to-slate-900"
    >
