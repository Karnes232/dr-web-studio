      ...
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-600 mb-4">
            Serving clients locally and internationally. We specialize in
            creating websites for businesses in the Caribbean and Latin America.
          </p>
          ...
          <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-4 border border-orange-200">
            ...
            <p className="text-orange-600 text-sm">
              Same timezone, cultural understanding, and bilingual support
              (Spanish/English)
            </p>
          </div>
        </div>
        ...
        <div className="bg-slate-50 rounded-lg p-4">
          ...
          <p className="text-slate-600 text-sm">
            For urgent website issues with existing clients, emergency support
            is available 24/7. Contact us via WhatsApp with "URGENT" in your
            message.
          </p>
        </div>
      </div>
