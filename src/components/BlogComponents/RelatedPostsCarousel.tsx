...
// The Swiper-enhanced view. Loaded via next/dynamic (ssr:false) from
// RelatedPosts so Swiper's JS+CSS stay out of the blog route's initial bundle —
// this section is below the fold. The static grid in RelatedPosts is the
// crawlable SSR fallback shown until this mounts.
const RelatedPostsCarousel = ({ posts, lang }: RelatedPostsCarouselProps) => {
  const { t } = useLocale()
