      ...
      <div className="md:flex">
        ...
        <div className="md:w-1/2 p-8">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            {post.tags && post.tags[lang]?.map((tag: string, index: number) => (
              <span
                key={index}
            ...
            <Link href={getLocalizedPath(`/blog/${post.slug.current}`)} className="inline-flex items-center bg-gradient-to-r from-orange-500 to-yellow-500 text-white px-6 py-3 rounded-lg font-medium hover:from-orange-600 hover:to-yellow-600 transition-all duration-200 shadow-md hover:shadow-lg transform hover:scale-105">
