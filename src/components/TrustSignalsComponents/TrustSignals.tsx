...
const TrustSignals = () => {
    const clientLogos = [
      ...
      const testimonials = [
        {
          quote: "DR Web Studio transformed our online presence completely. Our sales increased by 150% in just 3 months!",
          author: "Maria Rodriguez",
          company: "Boutique Fashion DR",
          rating: 5
        },
        {
          quote: "Professional, fast, and exactly what we needed. They understood our vision and delivered beyond expectations.",
          author: "Carlos Martinez",
          company: "Santo Domingo Restaurant",
          rating: 5
        },
        {
          quote: "The website loads incredibly fast and looks amazing on all devices. Our customers love the new design!",
          author: "Ana Jimenez",
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="text-center mb-16">
        ...
        <p className="text-xl text-gray-600">
          Join the growing number of successful businesses we've helped establish their online presence.
        </p>
      </div>
