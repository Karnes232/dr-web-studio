...
const HeroSection = () => {
  return (
    <section className="relative text-white overflow-hidden min-h-screen flex items-center">
      ...
      <div 
        className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900"
        style={{
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-center lg:text-left space-y-8">
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight">
              ...
              <span className="bg-gradient-to-r from-orange-400 to-yellow-400 bg-clip-text text-transparent"> Businesses </span>
              in the Dominican Republic
            </h1>
            
            <p className="text-xl lg:text-2xl text-gray-200 leading-relaxed">
              Custom websites that look great, load fast, and grow your business. Modern solutions tailored for Dominican enterprises.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-8 text-gray-300 pt-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-400">Across Dominican Republic</div>
                </div>
              </div>
          ...
          <div className="relative">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-8 border border-white/20 shadow-2xl transform hover:scale-105 transition-transform duration-300">
              <div className="bg-gradient-to-br from-orange-400 to-teal-500 rounded-xl p-8 text-center shadow-xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-3">Modern Web Solutions</h3>
                <p className="text-orange-100 text-lg">Built with Next.js, React & Tailwind CSS</p>
