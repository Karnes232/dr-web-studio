  ...
  return (
    ...
    <div className="bg-gradient-to-r from-orange-500 to-yellow-500 rounded-2xl p-8">
      ...
      <p className="text-orange-100 mb-6 max-w-2xl mx-auto">
        Let's discuss your website project and how I can help grow your business online. 
        Schedule a free consultation or get started with our project questionnaire.
      </p>
