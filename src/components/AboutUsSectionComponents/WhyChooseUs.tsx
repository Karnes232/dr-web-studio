    ...
    const reasons = [
        {
          ...
          description: "I know the Dominican market and can help you connect with local customers"
        },
        {
        ...
        },
        {
          ...
          description: "Maintenance and updates to keep your website running smoothly"
        }
      ];
  return (
