...
// Server component: the headline is the LCP element, so it must be painted from
// the server HTML immediately — no client entrance animation gating it behind
// hydration. The decorative mesh/grid overlays are desktop-only to spare mobile
// GPUs the extra full-screen paint.
  ...
  return (
    <section className="relative min-h-[92vh] flex items-center justify-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-6 py-24 text-center">
        {/* Badge */}
        {data.badge && (
          <div className="inline-flex items-center gap-2 px-4 py-2 mb-8 rounded-full border border-amber-500/30 bg-amber-500/10 text-amber-400 text-sm font-medium">
            {data.badge}
          </div>
        )}
        ...
        <div className="mt-20 mx-auto w-24 h-px bg-gradient-to-r from-transparent via-amber-500/60 to-transparent" />
      </div>
