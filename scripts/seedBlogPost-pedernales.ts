...
const posts: SeedPost[] = [
  {
    ...
    body: {
      ...
      es: [
        ...
        p("Los números no son especulativos. El proyecto Pedernales–Cabo Rojo es un desarrollo de aproximadamente US$2.2 mil millones liderado por un consorcio que incluye a Grupo Puntacana, diseñado para construir alrededor de 12,000 habitaciones de hotel para 2033. El puerto de cruceros de Cabo Rojo abrió en enero de 2024 y se movió rápido: manejó cerca de 177,000 cruceristas en 2025 a través de decenas de escalas de barcos, suficiente para superar tanto a Samaná como a Santo Domingo y convertirse en el tercer puerto de cruceros más activo del país por llegadas, con seis líneas mayores — Norwegian, Royal Caribbean, MSC, Holland America, Costa y Azamara — atracando ahora ahí. Un nuevo aeropuerto internacional con una pista lo bastante larga para los aviones de fuselaje ancho más grandes se está pavimentando para una apertura esperada a finales de 2026, y cadenas internacionales como Iberostar, Hyatt, Hilton y Marriott se han comprometido con la primera fase, con el primer gran todo-incluido esperado a abrir cerca del final de 2026. Esta no es una región esperando que quizás algún día lleguen turistas. Ya están llegando por barcos enteros."),
