...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        ...
        rich("normal", [
          run("•  "),
          run(
            "The cruise day-tripper. Two ports — Amber Cove and Taíno Bay — pour cruise passengers into Puerto Plata, which ",
          ),
          link(
            "handled about 78% of all Dominican cruise arrivals in 2025, more than two million passengers between the two terminals",
            "https://www.caribjournal.com/2026/01/12/dominican-republic-cruises-booming/",
          ),
          run(
            ". The most-visited day-trip from both is Sosúa, about thirty to forty minutes away, where a full ecosystem of shore excursions runs beach days, snorkeling, and catamaran charters. This visitor has a few hours, is researching from the ship or the pier, and books fast or not at all.",
          ),
        ]),
        rich("normal", [
          run("•  "),
        ...
        rich("normal", [
          run("•  "),
          run(
            "The resident expat. Thousands of North American and European residents live along the coast year-round — real-estate analysts describe the North Coast as seeing ",
          ),
          link(
            "the strongest expat growth in fifteen years",
            "https://www.drlistings.com/blog/dr-tourism-culture-lifestyle/",
          ),
          run(
            " — and they're not tourists at all. They're local customers who need the same services a resident anywhere needs, and who research them online exactly as they did back home.",
          ),
        ]),
        p(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Watersports schools. Kitesurf, windsurf, and surf schools are the North Coast's signature vertical, clustered on Kite Beach and Playa Encuentro, and they serve both the planning-ahead nomad and the cruise-overflow day visitor. A bookable, photo-rich, bilingual site is the difference between filling a lesson calendar and waiting for walk-ins — exactly the approach we lay out for ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Real estate and rentals. With entry-level oceanfront still reachable and short-term rentals a year-round business thanks to the off-season-proof kite winds, real estate is a major North Coast vertical, and foreign buyers research it entirely online, in English, the way we describe for ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Genuinely bilingual — and built for a multilingual community. English and Spanish are the baseline, but the North Coast's deep European expat presence means German and French traffic matter too. Each language needs its own real, indexed pages, built the way we describe in ",
          ),
          link(
            "bilingual SEO",
            "https://www.dr-webstudio.com/en/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno",
          ),
          run(", not a translate button."),
        ]),
        rich("normal", [
          run("•  "),
          run(
            "Fast on mobile. Every one of the three audiences researches on a phone — the cruise passenger on ship Wi-Fi, the nomad between sessions, the resident on the go — and ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Photo-forward, without the weight. The North Coast sells on action and scenery — a kite arcing over Kite Beach, the reef at Three Rocks, a waterfall at Damajagua — but heavy galleries kill mobile speed, so ",
          ),
          link(
            "image optimization",
        ...
        rich("normal", [
          run("•  "),
          run(
            "WhatsApp-connected, with online booking and deposits. Bookings close in a chat and the cruise visitor needs to lock something in fast, so one-tap ",
          ),
          link(
            "WhatsApp, Maps, and Instagram",
            "https://www.dr-webstudio.com/en/blog/how-to-connect-website-whatsapp-google-maps-instagram",
          ),
          run(" plus the ability to take a deposit via "),
          link(
            "local online payments",
            "https://www.dr-webstudio.com/en/blog/how-to-accept-online-payments-dominican-republic",
          ),
          run(" turns interest into a confirmed sale."),
        ]),
        rich("normal", [
          run("•  "),
          run(
      ...
      es: [
        ...
        rich("normal", [
          run("•  "),
          run(
            "El crucerista de un día. Dos puertos — Amber Cove y Taíno Bay — vierten cruceristas hacia Puerto Plata, que ",
          ),
          link(
            "manejó cerca del 78% de todas las llegadas de cruceros dominicanas en 2025, más de dos millones de pasajeros entre las dos terminales",
            "https://www.caribjournal.com/2026/01/12/dominican-republic-cruises-booming/",
          ),
          run(
            ". La excursión de un día más visitada desde ambos es Sosúa, a unos treinta o cuarenta minutos, donde un ecosistema completo de excursiones ofrece días de playa, snorkel y paseos en catamarán. Este visitante tiene unas pocas horas, investiga desde el barco o el muelle, y reserva rápido o no reserva.",
          ),
        ]),
        rich("normal", [
          run("•  "),
        ...
        rich("normal", [
          run("•  "),
          run(
            "El expatriado residente. Miles de residentes norteamericanos y europeos viven a lo largo de la costa todo el año — los analistas inmobiliarios describen la Costa Norte como la región con ",
          ),
          link(
            "el crecimiento de expatriados más fuerte en quince años",
            "https://www.drlistings.com/blog/dr-tourism-culture-lifestyle/",
          ),
          run(
            " — y no son turistas en absoluto. Son clientes locales que necesitan los mismos servicios que necesita un residente en cualquier parte, y que los investigan en línea exactamente como lo hacían en su país.",
          ),
        ]),
        p(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Genuinamente bilingüe — y construida para una comunidad multilingüe. El inglés y el español son la base, pero la profunda presencia de expatriados europeos de la Costa Norte significa que el tráfico en alemán y francés también importa. Cada idioma necesita sus propias páginas reales e indexadas, construidas como describimos en ",
          ),
          link(
            "SEO bilingüe",
            "https://www.dr-webstudio.com/es/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno",
          ),
          run(", no un botón de traducción."),
        ]),
        rich("normal", [
          run("•  "),
          run(
            "Rápida en móvil. Cada una de las tres audiencias investiga en un teléfono — el crucerista con el Wi-Fi del barco, el nómada entre sesiones, el residente en movimiento — y ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Protagonizada por fotos, sin el peso. La Costa Norte se vende por la acción y el paisaje — un kite arqueándose sobre Kite Beach, el arrecife de las Tres Rocas, una cascada en Damajagua — pero las galerías pesadas matan la velocidad móvil, así que la ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Conectada a WhatsApp, con reserva y depósitos en línea. Las reservas se cierran en un chat y el visitante de crucero necesita asegurar algo rápido, así que ",
          ),
          link(
            "WhatsApp, Maps e Instagram",
            "https://www.dr-webstudio.com/es/blog/como-conectar-sitio-web-whatsapp-google-maps-instagram",
          ),
          run(" en un toque más la capacidad de tomar un depósito vía "),
          link(
            "pagos en línea locales",
            "https://www.dr-webstudio.com/es/blog/como-aceptar-pagos-en-linea-republica-dominicana",
          ),
          run(" convierte el interés en una venta confirmada."),
        ]),
        rich("normal", [
          run("•  "),
          run(
    ...
    seo: {
      ...
      keywords: {
        en: [
          "North Coast website",
          "Cabarete kitesurf website",
          "Sosúa business website",
          "Puerto Plata web design",
          "Cabarete Sosúa tourism website",
        ],
        es: [
          "página web Costa Norte",
          "página web kitesurf Cabarete",
          "página web negocio Sosúa",
          "diseño web Puerto Plata",
          "página web turismo Cabarete Sosúa",
        ],
      },
    },
  },
