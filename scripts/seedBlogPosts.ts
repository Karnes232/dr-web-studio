...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        ...
        rich("normal", [run("For a photographer, a venue, or a decorator, the couple isn't buying a service description — they're buying the pictures. When we built the site for "), link("Punta Cana Photo Edition, a wedding photography studio", "https://www.dr-webstudio.com/en/blog/punta-cana-photo-edition-case-study-wedding-photography-punta-cana"), run(", the entire architecture served one goal: let the work sell itself, fast. That means real-wedding galleries organized the way couples browse (by venue, by style, by moment), images large enough to feel the day, and — the technical crux — aggressive optimization so a gallery of fifty photos still loads instantly on a phone in Toronto. Heavy, slow galleries are the single most common self-inflicted wound in this industry: the couple leaves before your best shot renders. The craft of having both beauty and speed is exactly what we detail in "), link("image optimization for tourism websites", "https://www.dr-webstudio.com/en/blog/optimizacion-imagenes-sitios-web-turismo-fotos-alta-calidad-carga-rapida"), run(", and nowhere does it matter more than here.")]),
        h2("Lesson 2: Your couples are planning from another country"),
        rich("normal", [run("The overwhelming majority of destination-wedding clients research in English — but not only English. Couples come from Quebec and France, from Germany, from Latin America, and each pair searches in its own language with its own phrases. Building "), link("Punta Cana Proposal Packages, a proposal-planning platform that runs in nine languages", "https://www.dr-webstudio.com/en/blog/punta-cana-proposal-packages-case-study-9-language-platform"), run(", proved the point at scale: each language version ranks independently in its own market, and inquiries arrive from searches the Spanish or English site alone would never have touched. Most wedding businesses don't need nine languages — but genuinely bilingual is the floor, built properly so "), link("each language ranks without cannibalizing the other", "https://www.dr-webstudio.com/en/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno"), run(", and a third language chosen from your actual inquiry data is often the highest-ROI expansion available.")]),
        h2("Lesson 3: The inquiry is the conversion — treat it like one"),
        rich("normal", [run("Wedding businesses obsess over traffic and neglect the moment that actually produces revenue: the inquiry. Two patterns from our builds matter here. First, the form should qualify, gently. Date, venue or location if known, approximate guest count, and how they found you — enough for you to reply with substance instead of twenty questions, but short enough that no one abandons it. Every additional required field costs you inquiries; every missing essential field costs you hours of back-and-forth. Second, WhatsApp beats email for speed, and speed wins bookings. Couples inquiry-blast several vendors at once, and the first professional, warm reply frequently frames the whole comparison. A one-tap "), link("WhatsApp path from every page", "https://www.dr-webstudio.com/en/blog/how-to-connect-website-whatsapp-google-maps-instagram"), run(" — alongside the form, not instead of it — captures the couples who want to talk now, and in this market that's most of them: "), link("82% of Dominican online-buying households use WhatsApp", "https://paymentscmi.com/insights/comercio-electronico-republica-dominicana-datos-clave/"), run(", and international couples have long since adopted it for exactly this kind of planning.")]),
        h2("Lesson 4: Proof beats promises, every time"),
        rich("normal", [run("Wedding marketing drowns in the same adjectives — magical, unforgettable, bespoke — and couples have learned to scroll past all of them. What stops the scroll is proof. When we rebuilt the digital presence for "), link("Sertuin Events, an event planner whose sales grew +150% after launch", "https://www.dr-webstudio.com/en/blog/sertuin-events-case-study-150-sales-growth-event-planner-punta-cana"), run(", the content strategy leaned on specifics: real weddings with real venues named, real couple testimonials with dates, real vendor collaborations. The same principle powers our venue and packages builds: transparent starting prices where the business model allows it, actual availability instead of \"contact us to learn more,\" and reviews embedded from platforms couples already trust. Vagueness reads as risk; specificity reads as competence. It's the Stanford credibility finding applied to the highest-emotion purchase there is.")]),
        h2("What every wedding and event website needs"),
        p("Across all four builds, the non-negotiable checklist converged:"),
        rich("normal", [run("•  "), run("A gallery architecture that loads fast and is organized the way couples actually browse.")]),
        rich("normal", [run("•  "), run("Genuinely bilingual content minimum, with the third language chosen from inquiry data.")]),
        rich("normal", [run("•  "), run("A qualifying inquiry form plus one-tap WhatsApp on every page, with reply-time discipline behind it.")]),
        rich("normal", [run("•  "), run("Named proof everywhere — real weddings, dated testimonials, transparent pricing signals.")]),
        rich("normal", [run("•  "), run("Practical logistics content: legal requirements for marrying in the DR, best months, venue transport — the questions every couple Googles, which almost no local vendor answers, and which therefore rank remarkably fast.")]),
        rich("normal", [run("•  "), run("Mobile-first performance, because the entire journey happens on a phone — the revenue link is laid out in "), link("how speed affects your sales", "https://www.dr-webstudio.com/en/blog/core-web-vitals-como-la-velocidad-afecta-tus-ventas-online"), run(".")]),
        rich("normal", [run("That last content point deserves emphasis: the wedding businesses that publish honestly useful planning answers become the site couples land on before they've chosen any vendor — which quietly makes them the first vendor considered.")]),
        h2("The inquiry calendar: build before engagement season"),
        rich("normal", [run("Wedding businesses run on a longer clock than the rest of tourism, and the website should be planned around it. Couples typically book destination vendors twelve to eighteen months before the wedding date, and inquiry volume surges after engagement season — the December-to-February stretch when a large share of proposals happen. Work the math backward: a couple engaged in December starts vendor research in January and February, which means your site needs to be launched, indexed, and ranking before the holidays to capture that wave — and a gallery refreshed with this season's best weddings enters the surge with its strongest material. The same clock governs content: your \"best months to marry in Punta Cana\" and legal-requirements pages do their heaviest work in Q1, so they should be published and aging by autumn. Miss the cycle and you don't lose a month of business — you lose the cohort, because the couples who booked competitors in February won't be back. It's the sharpest version of the timing rule that runs through every tourism vertical: websites earn during the season they were built before. And because destination couples book so far ahead, this season's website investment compounds twice — it fills next year's calendar while its content and reviews are still accruing authority for the year after that.")]),
        h2("What it costs"),
        rich("normal", [run("A professional wedding-business website — fast galleries, bilingual pages, qualifying forms, WhatsApp integration — runs around US$950 in the Dominican market, with multilingual expansion around US$800 more and larger platforms (venue directories, package configurators) quoted as custom builds. Full context is in "), link("what a website costs in the DR in 2026", "https://www.dr-webstudio.com/en/blog/cuanto-cuesta-pagina-web-republica-dominicana-2026"), run(", and the safe commissioning process in our "), link("step-by-step guide", "https://www.dr-webstudio.com/en/blog/steps-to-get-a-website-for-your-local-business"), run(". Against an average destination-wedding contract, the site pays for itself with a single booking it wins you — and it will be judged by couples spending far more than that.")]),
        h2("Built by the studio that's already inside this industry"),
        rich("normal", [run("Four wedding-industry builds mean "), link("DR Web Studio", "https://www.dr-webstudio.com/en"), run(" doesn't start your project guessing — we start it knowing what converts a couple planning from three thousand kilometers away, because we've watched it happen across planners, photographers, venues, and packages. You can inspect the work in our "), link("portfolio", "https://www.dr-webstudio.com/en/portfolio"), run(" and the named results in the case studies above. If your wedding or event business is ready for a website that books couples instead of just impressing them, "), link("contact us for a free consultation", "https://www.dr-webstudio.com/en/contact"), run(".")]),
      ],
      es: [
        p("Punta Cana es una de las capitales mundiales de las bodas de destino, y detrás de cada ceremonia en la playa hay un ecosistema de negocios locales — organizadoras, fotógrafos, venues, decoradores, catering, oficiantes — compitiendo por parejas que planifican todo desde otro país, sin verlo en persona, desde un teléfono. Hemos construido páginas web para cuatro negocios de esta industria: una organizadora de eventos, un estudio de fotografía de bodas, una plataforma de venues y un servicio de paquetes de boda. Este artículo es lo que esos cuatro proyectos nos enseñaron sobre lo que realmente funciona — no teoría, sino patrones que se repitieron en cada construcción."),
        h2("Por qué los negocios de bodas viven o mueren en línea"),
        p("Una pareja de destino no puede pasar por tu oficina. Todo lo que sabrán de ti antes de transferir un depósito viene de una pantalla: tu página web, tus reseñas, tu Instagram y la velocidad y calidez de tus respuestas. Eso convierte al vertical de bodas en la prueba más pura de calidad web de toda la economía turística — no hay tráfico de paso que salve una presencia débil en línea. También eleva lo emocional: las parejas están haciendo una de las compras más grandes de sus vidas para un día que no se puede repetir, así que su tolerancia a cualquier cosa que se sienta poco profesional, lenta o vaga es efectivamente cero. Cada lección de abajo fluye de esa realidad."),
        h2("Lección 1: La galería es el producto"),
        rich("normal", [run("Para un fotógrafo, un venue o un decorador, la pareja no está comprando una descripción de servicio — está comprando las imágenes. Cuando construimos el sitio de "), link("Punta Cana Photo Edition, un estudio de fotografía de bodas", "https://www.dr-webstudio.com/es/blog/punta-cana-photo-edition-caso-de-estudio-fotografia-bodas-punta-cana"), run(", toda la arquitectura sirvió a una meta: dejar que el trabajo se venda solo, rápido. Eso significa galerías de bodas reales organizadas como las parejas navegan (por venue, por estilo, por momento), imágenes lo bastante grandes para sentir el día, y — el punto técnico crucial — optimización agresiva para que una galería de cincuenta fotos siga cargando al instante en un teléfono en Toronto. Las galerías pesadas y lentas son la herida autoinfligida más común de esta industria: la pareja se va antes de que tu mejor toma se vea. El oficio de tener belleza y velocidad a la vez es exactamente lo que detallamos en "), link("optimización de imágenes para sitios web de turismo", "https://www.dr-webstudio.com/es/blog/optimizacion-imagenes-sitios-web-turismo-fotos-alta-calidad-carga-rapida"), run(", y en ningún lugar importa más que aquí.")]),
        h2("Lección 2: Tus parejas planifican desde otro país"),
        rich("normal", [run("La abrumadora mayoría de los clientes de bodas de destino investiga en inglés — pero no solo en inglés. Las parejas vienen de Quebec y Francia, de Alemania, de América Latina, y cada una busca en su propio idioma con sus propias frases. Construir "), link("Punta Cana Proposal Packages, una plataforma de planificación de propuestas que funciona en nueve idiomas", "https://www.dr-webstudio.com/es/blog/punta-cana-proposal-packages-caso-de-estudio-plataforma-9-idiomas-propuestas"), run(", probó el punto a escala: cada versión de idioma se posiciona de forma independiente en su propio mercado, y las consultas llegan de búsquedas que el sitio en español o inglés solo jamás habría tocado. La mayoría de los negocios de bodas no necesita nueve idiomas — pero genuinamente bilingüe es el piso, construido correctamente para que "), link("cada idioma se posicione sin canibalizar al otro", "https://www.dr-webstudio.com/es/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno"), run(", y un tercer idioma elegido de tus datos reales de consultas suele ser la expansión de mayor retorno disponible.")]),
        h2("Lección 3: La consulta es la conversión — trátala como tal"),
        rich("normal", [run("Los negocios de bodas se obsesionan con el tráfico y descuidan el momento que realmente produce ingresos: la consulta. Dos patrones de nuestras construcciones importan aquí. Primero, el formulario debe calificar, con suavidad. Fecha, venue o ubicación si se conoce, cantidad aproximada de invitados y cómo te encontraron — lo suficiente para que respondas con sustancia en vez de veinte preguntas, pero lo bastante corto para que nadie lo abandone. Cada campo obligatorio adicional te cuesta consultas; cada campo esencial ausente te cuesta horas de ida y vuelta. Segundo, WhatsApp le gana al correo en velocidad, y la velocidad gana reservas. Las parejas consultan a varios proveedores a la vez, y la primera respuesta profesional y cálida frecuentemente enmarca toda la comparación. Un camino de "), link("WhatsApp de un toque desde cada página", "https://www.dr-webstudio.com/es/blog/como-conectar-sitio-web-whatsapp-google-maps-instagram"), run(" — junto al formulario, no en su lugar — captura a las parejas que quieren hablar ahora, y en este mercado esas son la mayoría: "), link("el 82% de los hogares dominicanos que compran en línea usa WhatsApp", "https://paymentscmi.com/insights/comercio-electronico-republica-dominicana-datos-clave/"), run(", y las parejas internacionales lo adoptaron hace tiempo para exactamente este tipo de planificación.")]),
        h2("Lección 4: La prueba le gana a las promesas, siempre"),
        rich("normal", [run("El marketing de bodas se ahoga en los mismos adjetivos — mágico, inolvidable, personalizado — y las parejas aprendieron a pasarlos de largo. Lo que detiene el scroll es la prueba. Cuando reconstruimos la presencia digital de "), link("Sertuin Events, una organizadora de eventos cuyas ventas crecieron +150% tras el lanzamiento", "https://www.dr-webstudio.com/es/blog/sertuin-events-caso-de-estudio-150-crecimiento-ventas-organizadora-eventos-punta-cana"), run(", la estrategia de contenido se apoyó en lo específico: bodas reales con venues reales nombrados, testimonios reales de parejas con fecha, colaboraciones reales con proveedores. El mismo principio impulsa nuestras construcciones de venues y paquetes: precios de partida transparentes donde el modelo de negocio lo permite, disponibilidad real en vez de \"contáctanos para saber más\", y reseñas incrustadas de plataformas en las que las parejas ya confían. La vaguedad se lee como riesgo; la especificidad se lee como competencia. Es el hallazgo de credibilidad de Stanford aplicado a la compra de mayor emoción que existe.")]),
        h2("Lo que toda página web de bodas y eventos necesita"),
        p("A través de las cuatro construcciones, el checklist innegociable convergió:"),
        rich("normal", [run("•  "), run("Una arquitectura de galerías que carga rápido y está organizada como las parejas realmente navegan.")]),
        rich("normal", [run("•  "), run("Contenido genuinamente bilingüe como mínimo, con el tercer idioma elegido de los datos de consultas.")]),
        rich("normal", [run("•  "), run("Un formulario de consulta que califica más WhatsApp de un toque en cada página, con disciplina de tiempo de respuesta detrás.")]),
        rich("normal", [run("•  "), run("Prueba con nombre en todas partes — bodas reales, testimonios con fecha, señales transparentes de precio.")]),
        rich("normal", [run("•  "), run("Contenido de logística práctica: requisitos legales para casarse en RD, mejores meses, transporte a los venues — las preguntas que toda pareja googlea, que casi ningún proveedor local responde, y que por eso se posicionan notablemente rápido.")]),
        rich("normal", [run("•  "), run("Rendimiento mobile-first, porque todo el recorrido ocurre en un teléfono — el vínculo con los ingresos está en "), link("cómo la velocidad afecta tus ventas", "https://www.dr-webstudio.com/es/blog/core-web-vitals-como-la-velocidad-afecta-tus-ventas-online"), run(".")]),
        rich("normal", [run("Ese último punto de contenido merece énfasis: los negocios de bodas que publican respuestas de planificación honestamente útiles se convierten en el sitio donde las parejas aterrizan antes de elegir a cualquier proveedor — lo que silenciosamente los convierte en el primer proveedor considerado.")]),
        h2("Cuánto cuesta"),
        rich("normal", [run("Una página web profesional de negocio de bodas — galerías rápidas, páginas bilingües, formularios que califican, integración de WhatsApp — ronda los US$950 en el mercado dominicano, con la expansión multilingüe alrededor de US$800 más y las plataformas mayores (directorios de venues, configuradores de paquetes) cotizadas como construcciones a medida. El contexto completo está en "), link("cuánto cuesta una página web en RD en 2026", "https://www.dr-webstudio.com/es/blog/cuanto-cuesta-pagina-web-republica-dominicana-2026"), run(", y el proceso seguro para encargarla en nuestra "), link("guía paso a paso", "https://www.dr-webstudio.com/es/blog/pasos-para-encargar-una-pagina-web-negocio-local"), run(". Contra un contrato promedio de boda de destino, el sitio se paga solo con una sola reserva que te gane — y lo juzgarán parejas que gastan mucho más que eso. Vale también recordar el calendario: las parejas reservan proveedores de destino doce a dieciocho meses antes de la fecha, y el volumen de consultas se dispara tras la temporada de compromisos de diciembre a febrero — así que el sitio debe estar lanzado, indexado y posicionado antes de las fiestas para capturar esa ola, con la galería refrescada con las mejores bodas de la temporada.")]),
        h2("Construida por el estudio que ya está dentro de esta industria"),
        rich("normal", [run("Cuatro construcciones en la industria de bodas significan que "), link("DR Web Studio", "https://www.dr-webstudio.com/es"), run(" no empieza tu proyecto adivinando — lo empieza sabiendo qué convierte a una pareja que planifica desde tres mil kilómetros, porque lo hemos visto suceder con organizadoras, fotógrafos, venues y paquetes. Puedes inspeccionar el trabajo en nuestro "), link("portafolio", "https://www.dr-webstudio.com/es/portafolio"), run(" y los resultados con nombre en los casos de estudio de arriba. Si tu negocio de bodas o eventos está listo para una página web que reserve parejas en vez de solo impresionarlas, "), link("contáctanos para una consulta gratuita", "https://www.dr-webstudio.com/es/contacto"), run(".")]),
      ],
    },
    seo: {
      metaTitle: loc(
      ...
      keywords: {
        en: ["wedding business website", "wedding photographer website Punta Cana", "event planner website", "wedding venue website Dominican Republic"],
        es: ["página web para bodas", "página web fotógrafo de bodas Punta Cana", "página web organizadora de eventos", "diseño web bodas República Dominicana"],
      },
    },
  },
  {
    ...
    seo: {
      ...
      keywords: {
        en: ["medical website Dominican Republic", "dentist website Punta Cana", "clinic web design", "medical tourism website"],
        es: ["página web para médicos", "página web dentista República Dominicana", "diseño web clínicas", "turismo médico República Dominicana"],
      },
    },
  },
  {
    ...
    seo: {
      ...
      keywords: {
        en: ["real estate website Punta Cana", "property listing website", "real estate web design Dominican Republic", "realtor website Punta Cana"],
        es: ["página web inmobiliaria Punta Cana", "página web bienes raíces", "diseño web inmobiliarias República Dominicana", "plataforma de listados de propiedades"],
      },
    },
  },
  {
    ...
    featured: false,
    tags: {
      en: ["SEO", "Google", "indexing", "robots.txt", "Google Business Profile", "sitemap", "Dominican Republic", "troubleshooting"],
      es: ["SEO", "Google", "indexación", "robots.txt", "Perfil de Negocio de Google", "sitemap", "República Dominicana", "diagnóstico"],
    },
    ...
    body: {
      en: [
        ...
        rich("normal", [run("If you've worked through this list and your site is still missing, the issue is usually technical — an indexing block, a broken sitemap, or structural problems Google can't crawl — and worth a professional diagnosis. At "), link("DR Web Studio", "https://www.dr-webstudio.com/en"), run(" we build sites that are fast, properly indexed, structured for search, and connected to Google Business Profile from day one, and we can audit an existing site to find exactly why it's not showing up. If your website is invisible and you want it found, "), link("contact us for a free consultation", "https://www.dr-webstudio.com/en/contact"), run(" and we'll tell you what's actually wrong.")]),
      ],
      es: [
        p("Pocas cosas frustran tanto como pagar por una página web y luego buscar tu propio negocio en Google — y no encontrar nada. Escribes el nombre de tu empresa, tu servicio, tu ciudad, y aparecen tus competidores mientras tú no. La buena noticia: \"invisible en Google\" casi siempre lo causa uno de un puñado de problemas específicos y solucionables, no la mala suerte. Aquí están las siete causas más comunes por las que tu página web no aparece en Google, y cómo resolver cada una."),
        h2("Primero, entiende la diferencia entre \"no indexado\" y \"no posicionado\""),
        rich("normal", [run("Antes de diagnosticar, separa dos situaciones muy distintas, porque tienen arreglos distintos. No indexado significa que Google no tiene tu página en su base de datos en absoluto — no estás en la página diez, no estás en ninguna parte. No posicionado significa que Google sabe que tu página existe pero la coloca tan abajo que nadie la ve. La prueba más rápida: busca en Google `site:tudominio.com` (con tu dominio real). Si no aparece nada, tienes un problema de indexación — las causas 1 a 4 de abajo. Si tus páginas aparecen pero solo cuando buscas el nombre exacto de tu negocio, estás indexado pero no posicionado — las causas 5 a 7. Esta sola verificación te ahorra horas persiguiendo el arreglo equivocado.")]),
    ...
    seo: {
      ...
      keywords: {
        en: ["my website doesnt show up on google", "website not appearing on google", "why is my site not on google", "not indexed by google", "website invisible on google"],
        es: ["mi página web no aparece en google", "por qué mi sitio no aparece en google", "página web no indexada", "sitio web invisible en google", "no aparezco en google"],
      },
    },
  },
  {
    ...
    featured: false,
    tags: {
      en: ["SEO", "redesign", "migration", "301 redirects", "rankings", "web design", "Dominican Republic"],
      es: ["SEO", "rediseño", "migración", "redirecciones 301", "posicionamiento", "diseño web", "República Dominicana"],
    },
    categories: ["business-tips"],
    publishedAt: "2026-06-26T12:00:00.000Z",
    body: {
      en: [
        p("A website redesign should be a step forward — a faster, better-looking, more effective site. Too often it's a disaster no one sees coming: the new site launches, everyone admires it, and then three weeks later the leads dry up because the business quietly fell off Google. This happens constantly, and it's entirely avoidable. The rankings you've spent years building are an asset, and a redesign that ignores them can erase that asset overnight. Here's how to redesign your website without losing your SEO."),
        h2("Why redesigns destroy rankings in the first place"),
        p("Google's rankings are attached to specific things: your exact URLs, the content on each page, the signals that tell Google what each page is about, and the trust your domain has accumulated over time. A redesign that changes those things without accounting for them tells Google, in effect, that the site it knew is gone. Pages it ranked now return errors; content it valued has vanished or been reworded into something it doesn't recognize; the internal structure it mapped has been rebuilt. Google responds the only way it can — by dropping the pages it can no longer verify. The traffic loss isn't Google punishing you; it's Google losing track of you. Every step below exists to prevent that."),
      ...
      es: [
        ...
        rich("normal", [run("Más allá del contenido visible, las páginas cargan señales que Google lee pero los visitantes no: etiquetas de título y meta descripciones, estructura de encabezados, texto alternativo de imágenes y datos estructurados. Estos a menudo se borran en un rediseño porque son invisibles en la maqueta de diseño — nadie nota que desaparecieron hasta que el posicionamiento se resbala. Una migración cuidadosa los lleva todos: los mismos títulos de página (a menos que los estés mejorando deliberadamente), los mismos datos estructurados marcando tu negocio, horarios y reseñas para que sigas siendo elegible para los resultados enriquecidos de Google, como explicamos en "), link("datos estructurados para negocios dominicanos", "https://www.dr-webstudio.com/es/blog/datos-estructurados-negocios-dominicanos-resultados-enriquecidos-google"), run(". Y por supuesto el nuevo sitio no debe bloquear a Google accidentalmente — las trampas de \"noindex\" y robots.txt del día de lanzamiento que cubrimos en "), link("qué es robots.txt y si está bloqueando a Google", "https://www.dr-webstudio.com/es/blog/que-es-robots-txt-esta-bloqueando-google-sitio-web-dominicano"), run(" han matado más rediseños que cualquier falla de diseño.")]),
        h2("Paso 5: Lanza más rápido que antes, no más lento"),
        rich("normal", [run("Un rediseño es el momento perfecto para mejorar la velocidad — y un pésimo momento para lamentar perderla. Si el nuevo sitio es más pesado y lento que el anterior, puedes conservar cada URL perfectamente y aun así resbalar en el posicionamiento, porque "), link("la velocidad es un factor de posicionamiento y de conversión a la vez", "https://www.dr-webstudio.com/es/blog/core-web-vitals-como-la-velocidad-afecta-tus-ventas-online"), run(", especialmente en un mercado mobile-first como RD. Insiste en que el rediseño aterrice más rápido que lo que reemplaza. Una construcción moderna debería hacer tu sitio más rápido, no más bonito-pero-lento — y si un rediseño propuesto no puede prometer eso, cuestiona la tecnología detrás.")]),
        h2("Paso 6: Lanza, envía y observa de cerca"),
        p("Salir en vivo es el inicio del trabajo SEO, no el final. En el momento en que el nuevo sitio se lanza, envía tu sitemap actualizado a través de Google Search Console para que Google vuelva a rastrear la nueva estructura rápido. Luego observa: revisa Search Console por errores de rastreo y páginas \"no encontradas\" (cada una es una redirección omitida que arreglar de inmediato), y compara tu tráfico contra la base del Paso 1. Una caída pequeña y breve mientras Google reprocesa el sitio es normal; una caída sostenida significa que algo en la migración se rompió y necesita arreglo ahora, mientras aún es recuperable. Los negocios que monitorean las primeras semanas atrapan los problemas temprano; los que lanzan y miran hacia otro lado los descubren un trimestre demasiado tarde."),
        h2("El caso especial: cambiar de plataforma"),
        rich("normal", [run("Las migraciones son más riesgosas cuando también cambias de plataforma — WordPress a un stack moderno, un constructor a otro — porque las URLs, la estructura del contenido y los cimientos técnicos se mueven todos a la vez. Este es exactamente cuando el checklist completo de arriba se vuelve innegociable, y exactamente cuando las manos experimentadas más importan. Hecha correctamente, una migración de plataforma puede mejorar tu SEO — rendimiento más rápido, estructura más limpia, mejores cimientos técnicos — en vez de amenazarlo. Es el corazón de nuestro "), link("servicio de migraciones y reconstrucciones de sitios web", "https://www.dr-webstudio.com/es/nuestros-servicios/migraciones-y-reconstrucciones-de-sitios-web"), run(", donde la preservación del SEO está integrada en el proceso.")]),
        h2("Qué esperar en el cronograma"),
        rich("normal", [run("Incluso una migración impecable no mantiene el posicionamiento perfectamente quieto, y conocer el patrón normal te evita entrar en pánico — o pasar por alto un problema real. En los primeros días tras el lanzamiento, espera que Google vuelva a rastrear el sitio y algo de fluctuación mientras reprocesa tus páginas; el posicionamiento puede oscilar en ambas direcciones. Durante las siguientes dos a cuatro semanas, una migración bien ejecutada se reacomoda a sus posiciones anteriores y a menudo mejora, a medida que el sitio más rápido y limpio se gana el favor de Google. Lo que no deberías ver es una caída pronunciada que persiste más allá de las primeras semanas — esa es la firma de una redirección rota, contenido perdido o un bloqueo accidental, y significa volver por el checklist para encontrar qué se movió sin su posicionamiento. La distinción que importa: una caída breve que se recupera es el sistema funcionando; una caída sostenida es un error solucionable, no el destino. Como la ventana de recuperación es estrecha, esto es precisamente por qué el monitoreo del Paso 6 no es opcional — los rediseños que pierden el posicionamiento permanentemente son casi siempre los que nadie estaba observando.")]),
        h2("El rediseño como mejora, no como apuesta"),
        rich("normal", [run("Un rediseño debería hacer crecer tu tráfico, no arriesgarlo. Manejado con una migración adecuada — medida, con URLs mapeadas, contenido preservado, señales preservadas, más rápido y monitoreado — obtienes el mejor sitio y conservas cada posicionamiento que ganaste. En "), link("DR Web Studio", "https://www.dr-webstudio.com/es"), run(" tratamos la preservación del SEO como una parte obligatoria de cada rediseño y migración, no como una idea de último momento, porque perder el posicionamiento ganado con esfuerzo de un cliente no es un resultado aceptable. Si estás planeando reconstruir o mover tu sitio y quieres proteger lo que ya gana, "), link("contáctanos para una consulta gratuita", "https://www.dr-webstudio.com/es/contacto"), run(" — mapearemos el camino seguro antes de que una sola URL cambie.")]),
      ],
    },
    seo: {
      metaTitle: loc(
      ...
      keywords: {
        en: ["redesign website without losing seo", "website redesign seo", "migrate website keep rankings", "301 redirects redesign", "redesign without losing traffic"],
        es: ["rediseñar página web sin perder seo", "rediseño web seo", "migrar sitio mantener posicionamiento", "redirecciones 301 rediseño", "rediseño sin perder tráfico"],
      },
    },
  }
]
