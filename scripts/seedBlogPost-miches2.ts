...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        rich("normal", [
          run(
            "Miches has arrived. A decade ago it was a quiet fishing town on the Dominican Republic's northeast coast; today it's one of the most talked-about new destinations in the Caribbean, ",
          ),
          link(
            "named to The New York Times' list of 52 Places to Go in 2026",
            "https://www.travelmarketreport.com/destinations/articles/ready-for-business-dominican-republic-invites-you-to-discover-miches",
          ),
          run(
      ...
      es: [
        rich("normal", [
          run(
            "Miches llegó. Hace una década era un tranquilo pueblo de pescadores en la costa noreste de República Dominicana; hoy es uno de los destinos nuevos de los que más se habla en el Caribe, ",
          ),
          link(
            "incluido en la lista de The New York Times de 52 Lugares para Visitar en 2026",
            "https://www.travelmarketreport.com/destinations/articles/ready-for-business-dominican-republic-invites-you-to-discover-miches",
          ),
          run(
