...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        ...
        rich("normal", [
          run(
            "Jarabacoa, known as the \"City of Eternal Spring,\" sits around 500 meters up in the Cordillera Central with a mild 22°C climate year-round, and it's the gateway to Pico Duarte — at over 3,000 meters, the highest peak in the entire Caribbean. Constanza sits higher still, above 1,200 meters, cool enough that the surrounding hills have occasionally seen frost, and it's the country's agricultural breadbasket of strawberries, flowers, and vegetables. According to the ",
          ),
          link(
            "official Dominican Republic tourism board, Jarabacoa is the country's premier ecotourism and adventure destination, offering a cool, natural alternative to beach resorts",
            "https://www.godominicanrepublic.com/destinations/jarabacoa",
          ),
          run(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Genuinely bilingual, Spanish-forward. Unlike the coast's English-first tourism, the mountain market leans heavily Dominican, so Spanish comes first here — but the international adventure traveler makes real English pages essential too, built the way we describe in ",
          ),
          link(
            "bilingual SEO",
            "https://www.dr-webstudio.com/en/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno",
          ),
          run(", so both audiences find you in their own language."),
        ]),
        rich("normal", [
          run("•  "),
          run(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Fast on mobile. The weekender planning a quick escape and the traveler researching a trek both do it on a phone, and ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Photo-forward, without the weight. The mountains sell on scenery — a raft in the rapids, a waterfall, a sunrise from Pico Duarte — but heavy galleries kill mobile speed, so ",
          ),
          link(
            "image optimization",
        ...
        rich("normal", [
          run("•  "),
          run(
            "WhatsApp-connected, with deposits online — and this one is pointed. The mountains are cash-first, and ATMs in Jarabacoa and Constanza are known to run dry on busy weekends. The operator whose site lets a visitor secure a spot with an online deposit, using the tools in ",
          ),
          link(
            "accepting online payments in the DR",
            "https://www.dr-webstudio.com/en/blog/how-to-accept-online-payments-dominican-republic",
          ),
          run(", removes real friction — alongside one-tap "),
          link(
            "WhatsApp, Maps, and Instagram",
            "https://www.dr-webstudio.com/en/blog/how-to-connect-website-whatsapp-google-maps-instagram",
          ),
          run(" to start the conversation."),
        ]),
        ...
        rich("normal", [
          run(
            "Web development is remote work, so a business in Jarabacoa or Constanza doesn't need a developer in town — it needs one who understands the Dominican market and the mountains' distinctive dual audience of domestic weekenders and international adventurers. That's exactly what we do at ",
          ),
          link("DR Web Studio", "https://www.dr-webstudio.com/en"),
          run(
            ": fast, bilingual, bookable websites for Dominican tourism businesses, with WhatsApp and local payments wired in and the first year of maintenance included. Whether you're filling rafts on the Yaque del Norte, cabins in the pines, or seats on a Pico Duarte trek, the site that builds trust and books both your audiences is the one that wins the mountains. ",
          ),
          link(
      ...
      es: [
        ...
        rich("normal", [
          run("•  "),
          run(
            "Protagonizada por fotos, sin el peso. Las montañas se venden por el paisaje — un raft en los rápidos, una cascada, un amanecer desde el Pico Duarte — pero las galerías pesadas matan la velocidad móvil, así que la ",
          ),
          link(
    ...
    seo: {
      ...
      keywords: {
        en: [
          "Jarabacoa tourism website",
          "rafting website Jarabacoa",
          "Pico Duarte trek website",
          "Constanza tourism website",
          "adventure tour website Dominican Republic",
        ],
        es: [
          "página web turismo Jarabacoa",
          "página web rafting Jarabacoa",
          "página web caminata Pico Duarte",
          "página web turismo Constanza",
          "página web tour de aventura República Dominicana",
        ],
      },
    },
  },
