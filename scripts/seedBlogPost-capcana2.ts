...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        ...
        rich("normal", [run("To understand why the web bar is so high here, you have to understand the place. Cap Cana spans 30,000 acres of gated, master-planned luxury just seven minutes from Punta Cana International Airport. Inside it: the St. Regis Resort and Residences, with 200 hotel rooms, 70 branded residences, and 24/7 concierge and butler service; the Eden Roc; the Jack Nicklaus-designed Punta Espada golf course, ranked among the finest in the world; the largest marina in the Caribbean and the largest equestrian center; Scape Park; and the beaches and dining of Juanillo. "), link("Median asking prices run around US$389,000 for a condo and US$1.1 million for a villa", "https://www.drlistings.com/cap-cana/"), run(", with dozens of new luxury developments underway. The people who buy, rent, and vacation here are ultra-high-net-worth, globally mobile, and surrounded at every turn by five-star execution. Their standard for \"good\" is not the local average — it's the St. Regis average. Any business hoping to serve them is measured against that, whether it wants to be or not.")]),
      ...
      es: [
        ...
        rich("normal", [run("Para entender por qué la barra web es tan alta aquí, hay que entender el lugar. Cap Cana abarca 30,000 acres de lujo cerrado y planificado a solo siete minutos del Aeropuerto Internacional de Punta Cana. Dentro: el St. Regis Resort and Residences, con 200 habitaciones de hotel, 70 residencias de marca, y servicio de concierge y mayordomo 24/7; el Eden Roc; el campo de golf Punta Espada diseñado por Jack Nicklaus, clasificado entre los mejores del mundo; la marina más grande del Caribe y el centro ecuestre más grande; Scape Park; y las playas y la gastronomía de Juanillo. "), link("Los precios medianos de venta rondan los US$389,000 para un condominio y US$1.1 millones para una villa", "https://www.drlistings.com/cap-cana/"), run(", con decenas de nuevos desarrollos de lujo en marcha. Las personas que compran, alquilan y vacacionan aquí son de patrimonio ultra alto, globalmente móviles, y rodeadas a cada paso de ejecución de cinco estrellas. Su estándar para \"bueno\" no es el promedio local — es el promedio St. Regis. Cualquier negocio que espere servirles es medido contra eso, quiéralo o no.")]),
