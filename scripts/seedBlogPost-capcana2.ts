...
const posts: SeedPost[] = [
  {
    ...
    body: {
      en: [
        ...
        rich("normal", [
          run("•  "),
          run(
            "Speed that feels instant. A luxury client's patience is short and their expectation is immediate. A site that hesitates for even a couple of seconds breaks the spell of effortlessness that luxury depends on, and ",
          ),
          link(
            "speed is directly tied to whether they stay or leave",
        ...
        rich("normal", [
          run("•  "),
          run(
            "Photography that does the property justice, without slowing the site. This market is sold on imagery — the villa, the yacht, the sunset over Punta Espada — but enormous unoptimized images betray an amateur build and destroy speed, which is exactly the tension the ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Flawless multilingual polish. The Cap Cana client is international — American, European, Latin American — and a site that's fluent in their language, genuinely and not through a clumsy auto-translate, is a baseline courtesy at this level, built the way we describe in ",
          ),
          link(
          ...
          run(
            ". A grammatical error in the client's own language is a quiet disqualification.",
          ),
        ]),
        rich("normal", [
          run("•  "),
          run(
            "Frictionless, discreet contact. The luxury client expects to reach a human easily and privately — a direct, elegant path to WhatsApp or a concierge line, integrated cleanly the way we cover in ",
          ),
          link(
          ...
          run(", never a clumsy form that feels like a mass-market funnel."),
        ]),
        ...
        rich("normal", [
          run("•  "),
          run(
            "Luxury real estate and villa sales. With a median villa around US$1.1 million and residences reaching eight figures, the buyer researches extensively online before ever flying in. The listing site is the showroom, and it competes with St. Regis's own marketing — the formula we detail for ",
          ),
          link(
            "real estate websites",
            "https://www.dr-webstudio.com/en/blog/real-estate-websites-punta-cana",
          ),
          run(", executed at the highest tier."),
        ]),
        rich("normal", [
          run("•  "),
          run(
        ...
        rich("normal", [
          run(
            "Web development is remote work, so a business serving Cap Cana doesn't need a developer inside the gates — it needs one who understands both the Dominican market and the exacting standard the luxury client brings. That's exactly what we do at ",
          ),
          link("DR Web Studio", "https://www.dr-webstudio.com/en"),
          run(
            ": fast, beautiful, multilingual websites built with the polish this clientele expects, with elegant contact and the technical craft that keeps a photo-rich site loading instantly. We build for tourism businesses across the Dominican Republic, from the emerging frontiers to the luxury enclaves, and Cap Cana is where the quality of the build matters most. If your business serves this market and your website doesn't yet match the standard your clients expect, ",
          ),
          link(
      ...
      es: [
        ...
        rich("normal", [
          run("•  "),
          run(
            "Fotografía que le hace justicia a la propiedad, sin ralentizar el sitio. Este mercado se vende con imágenes — la villa, el yate, el atardecer sobre Punta Espada — pero las imágenes enormes sin optimizar delatan una construcción amateur y destruyen la velocidad, que es exactamente la tensión que resuelve el ",
          ),
          link(
        ...
        rich("normal", [
          run("•  "),
          run(
            "Un pulido multilingüe impecable. El cliente de Cap Cana es internacional — estadounidense, europeo, latinoamericano — y un sitio fluido en su idioma, genuinamente y no a través de una autotraducción torpe, es una cortesía base a este nivel, construido como describimos en ",
          ),
          link(
            "SEO bilingüe y multilingüe",
            "https://www.dr-webstudio.com/es/blog/seo-bilingue-posicionarse-ingles-espanol-sin-perjudicar-ninguno",
          ),
          run(
            ". Un error gramatical en el propio idioma del cliente es una descalificación silenciosa.",
          ),
        ]),
        rich("normal", [
          run("•  "),
          run(
            "Contacto discreto y sin fricción. El cliente de lujo espera alcanzar a un humano con facilidad y privacidad — un camino directo y elegante a WhatsApp o a una línea de concierge, integrado limpiamente como cubrimos en ",
          ),
          link(
        ...
        rich("normal", [
          ...
          run(
            " — hagamos tu primera impresión tan impecable como la experiencia que entregas.",
          ),
        ]),
      ],
    },
    seo: {
      ...
      keywords: {
        en: [
          "Cap Cana luxury website",
          "Cap Cana real estate website",
          "luxury villa rental website",
          "Cap Cana concierge website",
          "luxury web design Punta Cana",
        ],
        es: [
          "página web lujo Cap Cana",
          "página web inmobiliaria Cap Cana",
          "página web alquiler villas lujo",
          "página web concierge Cap Cana",
          "diseño web lujo Punta Cana",
        ],
      },
    },
  },
